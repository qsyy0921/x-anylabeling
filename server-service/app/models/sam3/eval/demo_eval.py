...
class DemoEval(COCOeval):
    ...
    def evaluateImg(self, imgId, catId, aRng, maxDet):
        ...
        result = {
            ...
            (
                "IL_perfect_pos" if len(gt) > 0 else "IL_perfect_neg"
            ): IL_perfect,
            "F": f_measure,
            "J": j_score,
            "J&F": JnF,
    ...
    def accumulate(self, p=None):
        ...
        self.eval["CGF1"] = (
            self.eval["positive_macro_F1"] * self.eval["IL_MCC"]
        )
        self.eval["CGF1_w0dt"] = (
            self.eval["positive_w0dt_macro_F1"] * self.eval["IL_MCC"]
        )
        self.eval["CGF1_micro"] = (
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[43] = _summarize(
                iouThr=0.75, metric="positive_w0dt_macro_F1"
            )
            return stats
