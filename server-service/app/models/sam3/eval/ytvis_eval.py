...
class YTVISevalMixin:
    ...
    def computeIoU(self, imgId, catId):
        ...
        def iou_tracklets(preds, gts):
            ...
            assert (
                union > 0
            ).all(), "There exists a tracklet with zero GTs across time. This is suspicious"
            return inter / union
    ...
    def prepare(self, predictions):
        ...
        for video_id, prediction in predictions.items():
            ...
            if "masks" in prediction:
                ...
                areas = [
                    [
                        0 if rle is None else rle.pop("area")
                        for rle in rles_per_obj
                    ]
            ...
            if self.save_per_frame_scores:
                ...
                for res, track_per_frame_scores in zip(
                    new_results, per_frame_scores
                ):
        ...
        if self.write_eval_metrics_file:
            ...
            video_np_level_metrics = [
                ...
                for (
                    video_id,
                    category_id,
                ), res in all_video_np_level_results.items()
            ]
            eval_metrics = {
